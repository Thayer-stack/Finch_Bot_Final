...
namespace Project_FinchControl
{
    ...
    class Program
    {
        ...
        private static void DisplayUserLoginScreen()
        {
            ...
            do
            {
                ...
                {
                    case "a":
                        userName = UserLoginScreen(validLogin);
                        break;
                    ...
                    case "c":
                        DeletUsersCredentials(usersCredentials);
                        break;
        ...
        private static string UserLoginScreen(bool validLogin)
        {
            ...
            do
            {
                ...
                FindUsersCredentials(usersCredentials);
        ...
        /// <summary>
        /// Delets the users credentials.
        /// </summary>
        /// <returns><c>true</c>, if users credentials was deleted, <c>false</c> otherwise.</returns>
        /// <param name="usersCredentials">Users credentials.</param>
        private static bool DeletUsersCredentials(string[] usersCredentials)
        {
            string datapath = @"Users_info/Users.txt";
            string[] usersCredentialsArray = new string[datapath.Length];
            bool validLogin = false;
        ...
        /// </summary>
        static void DisplayChangeTheTheme()
        {
            DisplayGetTheTheme();
            SetTheTheme();
        ...
        /// Displaies the change the theme.
        /// </summary>
        static void SetTheTheme()
        {
            ReadThemeFile(out ConsoleColor foregroundColor, out ConsoleColor backgroundColor);
        ...
        private static void ReadThemeFile(out ConsoleColor foregroundColor, out ConsoleColor backgroundColor)
        {
            string dataPath = @"Theme/Theme.txt";
        ...
        /// <param name="foregroundColor">Foreground color.</param>
        /// <param name="backgroundColor">Background color.</param>
        static void RightThemeToFile(ConsoleColor foregroundColor, ConsoleColor backgroundColor)
        {
            string dataPath = @"Theme/Theme.txt";
        ...
        /// Displaies the change the theme.
        /// </summary>
        static void DisplayGetTheTheme()
        {
            bool validResponse;
            ...
            RightThemeToFile(foregroundColor, backgroundColor);
        ...
        /// </summary>
        /// <param name="commands">Commands.</param>
        private static void ReadCommandsToFile(List<Command> commands)
        {
            string dataPath = @"Commands/Commands.txt";
        ...
        /// </summary>
        /// <param name="commands">Commands.</param>
        private static void RightCommandsToFile(List<Command> commands)
        {
            string dataPath = @"Commands/Commands.txt";
        ...
        private static void AccessNamedDataFile(string fileName)
        {
            using (FileStream readFile = new FileStream($@"../../Data/{fileName}", FileMode.Open, FileAccess.Read))
            {
        ...
        static void StaticGridArrayDataSet(int numberOfDataPoints, int frequencyOfData, Finch myFinch)
        {
            ...
            StaticGridArrayGetDataSet(numberOfDataPoints, frequencyOfData, myFinch, out string fileName);
        ...
        /// <param name="myFinch"></param>
        /// <returns></returns>
        static double[][] StaticGridArrayGetDataSet(int numberOfDataPoints, int frequencyOfData, Finch myFinch, out string fileName)
        {
            ...
            using (FileStream outFile = new FileStream($@"../Data/{fileName}.txt", FileMode.OpenOrCreate, FileAccess.ReadWrite))
            {
